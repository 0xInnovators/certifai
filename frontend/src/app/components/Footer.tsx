...
function Footer () {
    return (
      <div className="flex flex-col justify-start items-center md:flex-row md:justify-around md:items-start w-full gap-20 md:gap-0 py-10">
        <div className="flex w-full max-w-[400px] md:w-[30%] flex-col gap-3 items-center justify-center ">
          ...
          <div className="flex w-full max-w-[400px] md:w-[30%] flex-col gap-6 items-center justify-center ">
              ...
              <p className="m-auto md:mx-6 text-justify text-gray-500">CertifAI</p>
              <SocialMedia />
          </div>
